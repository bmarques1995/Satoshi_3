...
Satoshi::COMPILE_ERRORS Satoshi::D3D12ShaderCompiler::CompileFromFile(std::string_view baseShaderPath, std::string_view entrypoint, SHADER_KIND shaderKind, SHADER_VERSION shaderVersion, uint32_t optimizationLevel, uint32_t extraFlags)
{
...
const std::unordered_map<Satoshi::SHADER_KIND, std::string_view> Satoshi::D3D12ShaderCompiler::GetShaderKindStringMap()
{
...
void Satoshi::D3D12ShaderCompiler::BuildTarget(SHADER_KIND shaderKind, SHADER_VERSION shaderVersion)
{
...
void Satoshi::D3D12ShaderCompiler::BuildInputFile(SHADER_KIND shaderKind, std::string_view baseShaderPath)
{
...
void Satoshi::D3D12ShaderCompiler::BuildOutputFile(SHADER_KIND shaderKind, SHADER_VERSION hlslVersion, std::string_view baseShaderPath)
{

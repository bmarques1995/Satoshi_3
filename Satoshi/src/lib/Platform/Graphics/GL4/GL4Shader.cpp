...
std::unordered_map<Satoshi::GRAPHICS_SHADER_KIND, GLenum> Satoshi::GL4Shader::s_NativeShaderEnums =
{
    {GRAPHICS_SHADER_KIND::SHADER_KIND_VERTEX, GL_VERTEX_SHADER},
    {GRAPHICS_SHADER_KIND::SHADER_KIND_PIXEL, GL_FRAGMENT_SHADER},
    {GRAPHICS_SHADER_KIND::SHADER_KIND_GEOMETRY, GL_GEOMETRY_SHADER},
    {GRAPHICS_SHADER_KIND::SHADER_KIND_HULL, GL_TESS_CONTROL_SHADER},
    {GRAPHICS_SHADER_KIND::SHADER_KIND_DOMAIN, GL_TESS_EVALUATION_SHADER}
};
